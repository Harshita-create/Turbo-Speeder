...
function setup(){
  ...
  for(var initialPosition = (displayHeight*4)-500 , position = 500, xposition = 1; initialPosition>0; initialPosition = initialPosition-500 , position = position - 500, xposition = xposition+1){
    ...
    //if(xposition%2 === 0){
      if(num === 2 ){
      obstacle1 = new Obstacle(displayWidth/2+91,position-60)
      ...
      //car2
    obstacle3 = new Obstacle(displayWidth/2-85,position+30)
    obstacles.push(obstacle3)
     ...
     obstacles.push(obstacle4)
      ...
      //car4
      obstacle2 = new Obstacle(displayWidth/2+291+20,position-80)
      obstacles.push(obstacle2)
